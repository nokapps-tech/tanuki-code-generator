    ...
    protected function writeRoute(): static
    {
        ...
        $lines = match ($this->options['stack']) {
            'livewire' => [
                ...
                "Route::get('/{$this->_getRoute()}/{{$replacements['{{modelNameLowerCase}}']}}', \\$this->livewireNamespace\\{$replacements['{{modelNamePluralUpperCase}}']}\Show::class)->name('{$this->_getRoute()}.show');",
                "Route::get('/{$this->_getRoute()}/{{$replacements['{{modelNameLowerCase}}']}}/edit', \\$this->livewireNamespace\\{$replacements['{{modelNamePluralUpperCase}}']}\Edit::class)->name('{$this->_getRoute()}.edit');",
            ],
            'api' => [
